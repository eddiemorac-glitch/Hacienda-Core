...
export function Sidebar() {
    ...
    return (
        <aside className="w-20 md:w-64 border-r border-white/5 bg-slate-950/50 flex flex-col p-4 z-50 transition-all group overflow-hidden hover:w-64 h-screen">
            {/* Logo */}
            <div className="flex items-center gap-3 px-2 mb-6 h-10">
                <div className="min-w-10 h-10 bg-primary/20 rounded-xl flex items-center justify-center border border-primary/30">
                    <Shield className="w-5 h-5 text-primary" />
                </div>
                <span className="font-bold text-lg tracking-tight opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap text-white">HaciendaCore</span>
            </div>

            {/* Plan Badge */}
            <div className="px-2 mb-6 opacity-0 group-hover:opacity-100 transition-opacity">
            ...
            <div className="mt-auto pt-4 border-t border-white/5 flex flex-col gap-4">
                <div className="flex items-center gap-3 px-2">
                    ...
                    <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
